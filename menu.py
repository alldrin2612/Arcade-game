...
class Menu:
    ...
    def draw(self):
        ...
        title = font.render("Select Your Ship", True, self.WHITE)
    ...
    def start_game(self):
        # Initialize and run the game with the selected ship
        game = SpaceShooter(self.selected_ship)
        game.run()
